...
//    private Data data; TODO
    ...
    public boolean equals(Object o) {
        ...
        APortable aPortable = (APortable) o;

        if (bool != aPortable.bool) return false;
        if (b != aPortable.b) return false;
        if (c != aPortable.c) return false;
        if (Double.compare(aPortable.d, d) != 0) return false;
        if (s != aPortable.s) return false;
        if (Float.compare(aPortable.f, f) != 0) return false;
        if (i != aPortable.i) return false;
        if (l != aPortable.l) return false;
        if (byteSize != aPortable.byteSize) return false;
        if (unsignedByte != aPortable.unsignedByte) return false;
        if (unsignedShort != aPortable.unsignedShort) return false;
        if (str != null ? !str.equals(aPortable.str) : aPortable.str != null) return false;
        if (p != null ? !p.equals(aPortable.p) : aPortable.p != null) return false;
        if (!Arrays.equals(booleans, aPortable.booleans)) return false;
        if (!Arrays.equals(bytes, aPortable.bytes)) return false;
        if (!Arrays.equals(chars, aPortable.chars)) return false;
        if (!Arrays.equals(doubles, aPortable.doubles)) return false;
        if (!Arrays.equals(shorts, aPortable.shorts)) return false;
        if (!Arrays.equals(floats, aPortable.floats)) return false;
        if (!Arrays.equals(ints, aPortable.ints)) return false;
        if (!Arrays.equals(longs, aPortable.longs)) return false;
        if (!Arrays.equals(strings, aPortable.strings)) return false;
        if (!Arrays.equals(portables, aPortable.portables)) return false;
        if (!Arrays.equals(booleansNull, aPortable.booleansNull)) return false;
        if (!Arrays.equals(bytesNull, aPortable.bytesNull)) return false;
        if (!Arrays.equals(charsNull, aPortable.charsNull)) return false;
        if (!Arrays.equals(doublesNull, aPortable.doublesNull)) return false;
        if (!Arrays.equals(shortsNull, aPortable.shortsNull)) return false;
        if (!Arrays.equals(floatsNull, aPortable.floatsNull)) return false;
        if (!Arrays.equals(intsNull, aPortable.intsNull)) return false;
        if (!Arrays.equals(longsNull, aPortable.longsNull)) return false;
        if (!Arrays.equals(stringsNull, aPortable.stringsNull)) return false;
        if (!Arrays.equals(bytesFully, aPortable.bytesFully)) return false;
        if (!Arrays.equals(bytesOffset, aPortable.bytesOffset)) return false;
        if (!Arrays.equals(strChars, aPortable.strChars)) return false;
        if (!Arrays.equals(strBytes, aPortable.strBytes)) return false;
        if (portableObject != null ? !portableObject.equals(aPortable.portableObject) : aPortable.portableObject != null)
            return false;
        if (identifiedDataSerializableObject != null ? !identifiedDataSerializableObject.equals(aPortable.identifiedDataSerializableObject) : aPortable.identifiedDataSerializableObject != null)
            return false;
        if (customStreamSerializableObject != null ? !customStreamSerializableObject.equals(aPortable.customStreamSerializableObject) : aPortable.customStreamSerializableObject != null)
            return false;
        if (customByteArraySerializableObject != null ? !customByteArraySerializableObject.equals(aPortable.customByteArraySerializableObject) : aPortable.customByteArraySerializableObject != null)
            return false;
        return true;
//      return  !(data != null ? !data.equals(aPortable.data) : aPortable.data != null)
    ...
    public int hashCode() {
        ...
        result = 31 * result + (portables != null ? Arrays.hashCode(portables) : 0);
